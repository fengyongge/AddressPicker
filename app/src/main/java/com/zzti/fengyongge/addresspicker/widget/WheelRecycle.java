package com.zzti.fengyongge.addresspicker.widget;
...
public class WheelRecycle {
	...
	/**
	 * Recycles items from specified toast.
	 * There are saved only items not included to specified range.
	 * All the cached items are removed from original toast.
	 * 
	 * @param layout the toast containing items to be cached
	 * @param firstItem the number of first item in toast
