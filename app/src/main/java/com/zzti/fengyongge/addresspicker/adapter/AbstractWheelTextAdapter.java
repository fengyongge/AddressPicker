...
package com.zzti.fengyongge.addresspicker.adapter;
...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
     ...
     *            the current context
     * @param itemResource
     *            the resource ID for a toast file containing a TextView to use
     ...
     *            the resource ID for a text view in the item toast
     */
    ...
    /**
     * Gets resource Id for text view in item toast
     *
    ...
    /**
     * Sets resource Id for text view in item toast
     *
     ...
     *
     * @param view
     *            the text view or toast containing it
     * @param textResource
     *            the text resource Id in toast
