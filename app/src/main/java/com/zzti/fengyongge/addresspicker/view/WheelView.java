...
package com.zzti.fengyongge.addresspicker.view;
...
import com.zzti.fengyongge.addresspicker.R;
import com.zzti.fengyongge.addresspicker.adapter.WheelViewAdapter;
import com.zzti.fengyongge.addresspicker.widget.ItemsRange;
import com.zzti.fengyongge.addresspicker.widget.OnWheelChangedListener;
import com.zzti.fengyongge.addresspicker.widget.OnWheelClickedListener;
import com.zzti.fengyongge.addresspicker.widget.OnWheelScrollListener;
import com.zzti.fengyongge.addresspicker.widget.WheelRecycle;
import com.zzti.fengyongge.addresspicker.widget.WheelScroller;
...
public class WheelView extends View {
	...
	// The number of first item in toast
	 ...
	 * depends on wheel toast parameters. To apply changes and rebuild view
	 * call measure().
	 *
	 * @param count
	...
	/**
	 * Calculates desired height for toast
	 *
	 * @param layout
	 *            the source toast
	 * @return the desired toast height
	 */
	...
	/**
	 * Adds view for item to items toast
	 *
	 * @param index
	 *            the item index
	 * @param first
